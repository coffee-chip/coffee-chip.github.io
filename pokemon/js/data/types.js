...
// Bundled game-rule data. It is the single source of truth for all type tools.
const CURRENT_OFFENSIVE_CHART = {
...
function copyChart() {
  return Object.fromEntries(TYPES.map(type => [type, { ...CURRENT_OFFENSIVE_CHART[type] }]));
}
