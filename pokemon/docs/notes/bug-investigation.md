...
- 2026.08.27.6 distinguishes a first service-worker claim from an actual worker replacement. First-time installs no longer reload the page during startup; installed clients still reload when an update takes control.
